        ...
        <div className="layer layer2">
            <div className="vcard">
                <div className="inner">
                    ...
                    <div className="about">
                        <p>
                            I am a developer and technology enthusiast from Prague. I ❤️ new technologies. Especially
                            technologies on the web (<a href="/virtualni-realita-na-webu-2018-11-14">like WebVR</a>).
                        </p>
                        <p>
                            I speak at tech conferences (e.g.
                            <a href="https://www.youtube.com/watch?v=i7gQtatWSKc">LinuxDays about BrowserAPIs</a>) and
                            organize tech/startup communities (e.g.
